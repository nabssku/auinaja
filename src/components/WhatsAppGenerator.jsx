...
[B]: Iyaa, turun gih, aku tunggu 5 menit lagi ya.`);
  ...
  const [messages, setMessages] = useState([
    { id: '1', type: 'system', text: 'HARI INI', time: '' },
    { id: '2', type: 'receiver', text: 'Kamu udah tidur belum?', time: '21:40', status: 'read', isVoice: false },
    { id: '3', type: 'sender', text: 'Belum nih kak, lagi ngerjain revisian skripsi :(', time: '21:41', status: 'read', isVoice: false },
    { id: '4', type: 'receiver', text: 'Mau martabak telur ga? Aku lagi di depan komplek kamu nih', time: '21:41', status: 'read', isVoice: false },
    { id: '5', type: 'sender', text: 'SERIUSAN KAK? 😭❤️', time: '21:42', status: 'read', isVoice: false },
    { id: '6', type: 'receiver', text: 'Iyaa, turun gih, aku tunggu 5 menit lagi ya.', time: '21:42', status: 'read', isVoice: false }
  ]);
  ...
  const handleParseScript = () => {
    ...
    const parsed = [
      { id: 's_0', type: 'system', text: 'HARI INI', time: '' }
    ];
              ...
              <div className="p-3.5 bg-neutral-900/70 rounded-xl border border-neutral-800 space-y-3">
                ...
                <div className="pt-2">
                  <label className="flex items-center gap-2 cursor-pointer text-xs text-neutral-300">
                    ...
                    />
                    <span>Tampilkan Watermark AUinAja di preview</span>
                  </label>
                </div>
              </div>
            </div>
